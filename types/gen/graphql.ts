...
/** The template assigned to the node */
export type Template_Blogalternativ = ContentTemplate & {
  __typename?: 'Template_Blogalternativ';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};

/** The template assigned to the node */
export type Template_Leer = ContentTemplate & {
  __typename?: 'Template_Leer';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']>;
};
